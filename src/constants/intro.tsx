...
export const aboutText: AboutTextProp[] = [
  {
    ...
    answerTxt: (
      <>
        ...
        을 만드는 걸 좋아하는 프론트엔드 개발자 노수민입니다. 깔끔한 UI,
        직관적인 UX를 고민하며, 눈에 보이는 것부터 보이지 않는 흐름까지 세심하게
        신경 쓰는 편이에요. 요즘은 React, Next.js, TypeScript로 이것저것
        시도해보고 있고, 새로운 것을 배우고 기록하는 걸 즐깁니다.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answerTxt: (
      <>
        ...
        서버와 클라이언트 환경의 차이를 체감했거든요. 이런 시행착오 과정들을
        블로그에 '고민의 흔적'으로 기록해두는데, 나중에 비슷한 상황에서 도움이
        되더라고요. 실패도 좋은 학습이라고 생각해요.
      </>
    ),
  },
];
