...
// 텍스트 공통 베이스 스타일
const BASE_HIGHLIGHT_STYLE: HighLightStyle =
  'px-2 py-1 rounded-lg border font-medium';

// 색상별 강조 스타일 생성 함수
const createHighlightStyle = (color: string): HighLightStyle =>
  `text-${color}-light bg-${color}/8 ${BASE_HIGHLIGHT_STYLE} border-${color}/30`;
