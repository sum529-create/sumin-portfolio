  ...
  return (
    <section id='skills' className='relative min-h-screen py-20'>
      <div className='container mx-auto max-w-full px-4'>
        ...
        {/* 문 컨테이너 */}
        <div className='relative h-[600px] overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800'>
          {/* 뒤에 숨겨진 Tech Stack 내용 */}
          <div className='absolute inset-0 p-8'>
            <div
              className='grid h-full grid-cols-3 gap-6 text-gray-300'
              data-direction='doorContent'
            >
              {/* 실제 Tech Stack 카드들 */}
              {/* <TechStackCard title='현재 주력기술' techs={currentTech} />
              <TechStackCard title='실무 경험' techs={workExperience} />
              <TechStackCard title='프로젝트 경험' techs={projectExperience} /> */}
            </div>
          </div>
